...
export const TechStack = () => {
  ...
  return (
    <section className="mx-auto max-w-screen-lg mb-60">
      <h3 className=" text-5xl font-bold text-headingWhite text-center font-Poppins leading-7 mb-12">Tech Stack</h3>
      <span className=" text-3xl text-center text-lightContent font-Poppins leading-7 block mb-24 ">
