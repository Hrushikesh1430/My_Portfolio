...
export const Work = () => {
  return (
    <section className="mx-auto max-w-screen-lg mb-52">
      <h3 className=" text-5xl font-bold text-headingWhite text-center font-Poppins leading-7 mb-24">Work History</h3>
      <div className="flex flex-col text-headingWhite">
        {WorkJSON.map((item: workExp, index) => (
          <div className="flex mb-5 text-lg gap-7 font-Poppins" key={index}>
